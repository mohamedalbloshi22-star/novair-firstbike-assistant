...
## 4. اختبار الدورة الشهرية — مطلوب
على عميل اختبار فقط:
- اجعل `cycle_end` مستحقًا.
- عند أول طلب جديد يجب تحريك الدورة تلقائيًا.
- يبدأ عداد الدورة الجديدة من صفر.
- يبقى سجل الدورة السابقة محفوظًا.
...
لا يتم الدمج قبل:
- نجاح اختبار الدورة الشهرية والواجهات.
